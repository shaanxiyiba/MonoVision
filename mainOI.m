function mainOI(pitchStart,pitchInc,pitchEnd,rollStart,rollInc,rollEnd,yawStart,yawInc,yawEnd,xStart,xInc,xEnd,yStart,yInc,yEnd,zStart,zInc,zEnd)
%myFun - Description
%
...
x = [-90 -90 -90 0 0 0 90 90];
y = [-90 0 90 -90 0 90 -90 0];
X = [x;y];
X(3,:) = 1;
...
for n = yawStart:yawInc:yawEnd
  ...
  [Angle,t] = poseCalcOI(X,Y,M,0.03,1000);
